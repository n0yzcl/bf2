...
###############################################################################################
# This script has 'different' manage method. Why different?                                   #
...
# c4 [value] # Enable or disable C4 restriction. 0-Disable  1-Enable                          #
# claymore         # Return status of CLAYMORE restriction                                    #
# claymore [value] # Enable or disable CLAYMORE restriction. 0-Disable  1-Enable              #
# mgs         # Return status of MOUNTED MGS restriction                                      #
# mgs [value] # Enable or disable MOUNTED MGS restriction. 0-Disable  1-Enable                #
# tow         # Return status of TOW MISSILE restriction                                      #
# tow [value] # Enable or disable TOW MISSILE restriction. 0-Disable  1-Enable                #
#                                                                                             #
...
# anticomm [value]   # Enable or disable commander restriction. 0-Disable  1-Enable           #
# commkick           # Return status of COMMANDER KICKER system                               #
# commkick [value]   # Enable or disable commander kicking. 0-Disable  1-Enable               #
...
# miscellaneous weapons: c4, claymore, stationary mgs and tow missile #
...
def checkAndJudge(WeaponList,attacker,weapon,method):
	if not method:
		...
		if str(weapon.templateName) not in WeaponList: KickerSystem(attacker)
...
def changedWeapon(WeaponList, player, weapon, method):
	...
	if not method:
		...
		if str(weapon.templateName) not in WeaponList:
			if not PUNISH_METHOD:
				host.sgl_sendTextMessage( 0, 12, 1, str(WARNING_LVL0)  % (player.getName()), 0)
			else:
				player.getDefaultVehicle().setDamage(0)
